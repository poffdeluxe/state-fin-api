...
def get_index_from_state_code(state_code: StateCode):
    return f"{state_code}_contribs"
...
async def get_complete_summary(
    ...
    return serialize_summary_result(raw_res, start_date, end_date)
...
async def get_state_summary(
    ...
    query = build_summary_query(start_date, end_date, addtl_aggs=district_aggs)
    raw_res = es.search(query, get_index_from_state_code(state_code))

    result = serialize_summary_result(raw_res, start_date, end_date)
